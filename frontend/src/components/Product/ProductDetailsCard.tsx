...
const ProductDetailsCard: React.FC<ProductDetailsProps> = ({ dish, onBack }) => {
  // ✅ Ensure dish.id exists before calling hook
    ...
    <div className="w-full max-w-4xl mx-auto p-6 md:p-8">
      ...
      <Card className="w-full max-w-xxl grid grid-cols-1 md:grid-cols-2 gap-8 items-start shadow-lg p-6">
        <div className="relative">
          <img
            src={dish.image || "/placeholder-image.jpg"} // ✅ Default placeholder
            alt={dish.name}
        ...
        <div className="flex flex-col justify-between space-y-4">
          ...
          {/* Variation & Quantity */}
          <CardContent className="">{/* Add future content here */}</CardContent>
