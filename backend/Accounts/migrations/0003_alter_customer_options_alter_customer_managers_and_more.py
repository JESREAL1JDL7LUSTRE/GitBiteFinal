...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Accounts', '0002_remove_customer_customer_id'),
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='customer',
            name='password',
            field=models.CharField(default='pbkdf2_sha256$870000$W0lR0edlSY5WZFBE3gnEyQ$yZvLzQ6EaBLDQpp1YImqIP5jpnNsbSuiFSZcNXDU1Cg=', max_length=10000),
        ),
        migrations.AlterField(
            model_name='customer',
            name='username',
